...
@protocol EditCoverViewDelegate
...
@interface EditCoverView : UIView

@property (nonatomic,weak) id<EditCoverViewDelegate> editDataViewDelegate;
@property (nonatomic,strong) PersonHomeDM * personHomeModel;
@property (nonatomic,strong) NSMutableArray * dataArr;//collectionView数据源
- (void)replaceImage:(UIImage *)image;//替换
