...
@interface MyCollectionViewController ()<VTMagicViewDataSource,VTMagicViewDelegate,MyCollectionColViewControllerDelegate>
...
- (void)addViews{
    ...
    [magicController.magicView setItemWidth:kMainScreenWidth];
...
- (UIViewController *)magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex{
    ...
    MyCollectionColViewController *myCollectionColVC = [magicView dequeueReusablePageWithIdentifier:recomId];
    
    if (!myCollectionColVC) {
        
        myCollectionColVC = [[MyCollectionColViewController alloc] init];
        
        [myCollectionColVC setM_Delegate:self];
        
    }
    
    [myCollectionColVC setMyCollectionColViewController:pageIndex];
    
    return myCollectionColVC;
...
#pragma mark - MyCollectionColViewController Delegate Manager
