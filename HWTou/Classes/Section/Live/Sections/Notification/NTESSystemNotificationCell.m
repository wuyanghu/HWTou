...
- (void)layoutSubviews{
    ...
    self.avatarImageView.ntesLeft = AvatarImageViewLeft;
    if (self.textLabel.ntesWidth > MaxTextLabelWidth) {
        self.textLabel.ntesWidth = MaxTextLabelWidth;
    }
    if (self.detailTextLabel.ntesWidth > MaxDetailLabelWidth) {
        self.detailTextLabel.ntesWidth = MaxDetailLabelWidth;
    }
    self.textLabel.ntesLeft = self.avatarImageView.ntesRight + MessageAndAvatarSpacing;
    self.detailTextLabel.ntesLeft = self.textLabel.ntesLeft;
    self.detailTextLabel.ntesBottom = self.avatarImageView.ntesBottom;
    
    if (self.messageLabel.ntesWidth > MaxMessageLabelWidth) {
        self.messageLabel.ntesWidth = MaxMessageLabelWidth;
    }
    self.messageLabel.ntesLeft = self.textLabel.ntesRight + TextLabelAndMessageLabelSpacing;
