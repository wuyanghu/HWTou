...
- (void)layoutSubviews{
    ...
    self.textField.ntesWidth  = self.ntesWidth - textFieldLeft - textFieldRight;
    self.textField.ntesHeight = 44.f;
    self.textField.ntesCenterX = self.ntesWidth * .5f;
    self.textField.ntesCenterY = self.ntesHeight * .5f;
}
