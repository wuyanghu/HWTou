...
- (void)layoutSubviews{
    ...
    self.nameLabel.ntesTop   = self.avatarImageView.ntesTop;
    self.nameLabel.ntesLeft  = self.avatarImageView.ntesRight + spacing;
    self.countIconImageView.ntesBottom = self.avatarImageView.ntesBottom;
    self.countIconImageView.ntesLeft = self.avatarImageView.ntesRight + spacing;
    self.countLabel.ntesCenterY = self.countIconImageView.ntesCenterY;
    self.countLabel.ntesLeft  = self.countIconImageView.ntesRight + spacing;
    self.topSep.ntesWidth     = self.ntesWidth;
    self.bottomSep.ntesWidth  = self.ntesWidth;
    self.bottomSep.ntesBottom = self.ntesHeight;
}
