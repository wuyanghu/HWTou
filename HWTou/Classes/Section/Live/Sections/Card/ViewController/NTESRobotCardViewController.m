...
- (void)refresh
{
    ...
    CGSize size = [self.introLabel sizeThatFits:CGSizeMake(self.introLabel.ntesWidth, CGFLOAT_MAX)];
    self.introLabel.ntesSize = size;
}
...
- (void)viewDidLayoutSubviews
{
    ...
    CGSize size = [self.chatButton sizeThatFits:CGSizeMake(self.view.ntesWidth, CGFLOAT_MAX)];
    self.chatButton.ntesSize = size;
    self.chatButton.ntesCenterX = self.view.ntesWidth * .5f;
    self.chatButton.ntesBottom  = self.view.ntesHeight - 30.f;
    
    self.introLabel.ntesCenterX = self.view.ntesWidth * .5f;
}
