...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _button.ntesSize = [_button sizeThatFits:CGSizeMake(self.ntesWidth, CGFLOAT_MAX)];
...
- (void)layoutSubviews{
    ...
    _button.ntesCenterX = self.ntesWidth * .5f;
    _button.ntesCenterY = self.ntesHeight * .5f;
}
