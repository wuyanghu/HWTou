...
- (void)viewDidLoad{
    ...
    self.header = [[NTESListHeader alloc] initWithFrame:CGRectMake(0, 0, self.view.ntesWidth, 0)];
...
- (void)onLogin:(NIMLoginStep)step{
    ...
    self.titleLabel.ntesCenterX   = self.navigationItem.titleView.ntesWidth * .5f;
...
- (void)refreshSubview{
    ...
    {
        self.header.ntesTop = self.view.safeAreaInsets.top;
        self.tableView.ntesTop = self.header.ntesBottom;
    ...
    {
        self.tableView.ntesTop = self.header.ntesHeight;
        self.header.ntesBottom    = self.tableView.ntesTop + self.tableView.contentInset.top;
    }
    self.tableView.ntesHeight = self.view.ntesHeight - self.tableView.ntesTop;
    
    self.emptyTipLabel.ntesCenterX = self.view.ntesWidth * .5f;
    self.emptyTipLabel.ntesCenterY = self.tableView.ntesHeight * .5f;
}
...
- (UIView*)titleView:(NSString*)userID{
    ...
    titleView.ntesWidth  = subLabel.ntesWidth;
    titleView.ntesHeight = self.titleLabel.ntesHeight + subLabel.ntesHeight;
    
    subLabel.ntesBottom = titleView.ntesHeight;
