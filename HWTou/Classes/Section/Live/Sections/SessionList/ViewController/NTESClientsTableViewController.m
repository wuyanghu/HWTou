...
- (void)viewDidLayoutSubviews{
    ...
    CGSize size = [header sizeThatFits:self.view.ntesSize];
    header.ntesSize = size;
...
- (void)layoutSubviews{
    ...
    self.icon.ntesTop     = IconTop;
    self.icon.ntesCenterX = self.ntesWidth * .5f;
}
