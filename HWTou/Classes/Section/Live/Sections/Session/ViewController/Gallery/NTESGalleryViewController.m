...
- (void)loadImage
{
    ...
    self.scrollView.contentSize = CGSizeMake(self.scrollView.ntesWidth - insets.left - insets.right,
                                             self.scrollView.ntesHeight - insets.top - insets.bottom);
...
- (void)layoutGallery:(CGSize)size
{
    ...
    {
        self.galleryImageView.ntesSize = CGSizeMake(width * scale, height * scale);
        self.scrollView.contentSize = self.galleryImageView.ntesSize;
        self.galleryImageView.contentMode = UIViewContentModeScaleAspectFill;
    }
    else
    {
        self.galleryImageView.ntesSize = self.scrollView.contentSize;
        self.galleryImageView.contentMode = UIViewContentModeScaleAspectFit;
    }
    
    self.galleryImageView.ntesCenterY = self.galleryImageView.ntesHeight * .5f ;
}
...
- (void)layoutSubviews{
    ...
    self.progressView.ntesCenterY = self.ntesHeight *.5;
    self.progressView.ntesCenterX = self.ntesWidth  *.5;
}
