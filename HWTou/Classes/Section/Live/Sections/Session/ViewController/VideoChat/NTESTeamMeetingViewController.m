...
- (void)viewDidLayoutSubviews
{
    ...
    self.collectionView.ntesWidth = self.view.ntesWidth;
    self.collectionView.ntesHeight = self.view.ntesWidth;
    CGFloat spacing = 15.f;
    self.durationLabel.ntesTop = self.collectionView.ntesBottom + spacing;
}
...
{
    CGFloat width  = collectionView.ntesWidth / self.rowsInSection;
