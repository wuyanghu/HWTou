...
- (void)viewDidLayoutSubviews{
    ...
    self.errorTipView.ntesTop = rect.size.height * .33f;
    self.errorTipView.ntesCenterX = rect.size.width * .5f;
}
        ...
        text:(NSString *)text
{
    ...
    else
    {
        _textView.text = text;
        [_textView sizeToFit];
        if (self.textView.ntesHeight + self.textView.ntesTop > self.view.ntesHeight) {
            self.textView.ntesHeight = self.view.ntesHeight - self.textView.ntesTop;
