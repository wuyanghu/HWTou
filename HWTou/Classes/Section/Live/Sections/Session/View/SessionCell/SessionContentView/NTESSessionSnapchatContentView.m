...
- (void)layoutSubviews{
    ...
    self.label.ntesLeft = self.model.message.isOutgoingMsg ? self.imageView.ntesLeft - customSnapMessageImageRightToText - self.label.ntesWidth : self.imageView.ntesRight + customSnapMessageImageRightToText;
    self.label.ntesBottom = self.imageView.ntesBottom - customSnapMessageTextBottom ;
