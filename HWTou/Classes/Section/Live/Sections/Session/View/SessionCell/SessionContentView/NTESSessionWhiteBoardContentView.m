...
- (void)layoutSubviews{
    ...
    CGFloat tableViewWidth = self.superview.ntesWidth;
    CGSize contentSize = [self.model contentSize:tableViewWidth];
    self.imageView.ntesLeft = contentInsets.left;
    self.imageView.ntesCenterY = self.ntesHeight * .5f;
    CGFloat customWhiteBorardMessageImageRightToText = 5.f;
    CGRect labelFrame = CGRectMake(self.imageView.ntesRight + customWhiteBorardMessageImageRightToText, contentInsets.top, contentSize.width, contentSize.height);
