...
+ (NIMMessage *)msgWithAnchorOnline
{
    NIMMessage *message        = [[NIMMessage alloc] init];
    NIMCustomObject *object    = [[NIMCustomObject alloc] init];
    NTESAnchorOnlineAttachment *attachment = [[NTESAnchorOnlineAttachment alloc] init];
    object.attachment          = attachment;
    message.messageObject      = object;
    return message;
}

+ (NIMMessage *)msgWithAnchorGiveAReward:(NSString *)money
{
    NIMMessage *message        = [[NIMMessage alloc] init];
    NIMCustomObject *object    = [[NIMCustomObject alloc] init];
    NTESAnchorGiveARewardAttachment *attachment = [[NTESAnchorGiveARewardAttachment alloc] init];
    attachment.money           = money;
    object.attachment          = attachment;
    message.messageObject      = object;
    return message;
}

+ (NIMMessage *)msgWithAnchorDisclose:(NSString *)money nickName:(NSString *)nickName
{
    NIMMessage *message        = [[NIMMessage alloc] init];
    NIMCustomObject *object    = [[NIMCustomObject alloc] init];
    NTESAnchorDiscloseAttachment *attachment = [[NTESAnchorDiscloseAttachment alloc] init];
    attachment.money           = money;
...
+ (NIMCustomSystemNotification *)notificationWithStopLive:(NSString *)roomId
{
    NSString *content = [@{@"command":@(NTESLiveCustomNotificationTypeStopLive),@"roomid" : roomId} jsonBody];
    NIMCustomSystemNotification *notification = [[NIMCustomSystemNotification alloc] initWithContent:content];
    notification.sendToOnlineUsersOnly = YES;
    return notification;
}
