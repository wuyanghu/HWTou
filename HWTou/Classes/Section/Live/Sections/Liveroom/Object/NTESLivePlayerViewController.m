...
- (void)adjustPlayerViewFromMobile:(CGSize)size
{
    ...
    CGFloat scaleW = superview.ntesWidth/size.width;
    CGFloat scaleH = superview.ntesHeight/size.height;
    ...
    //放到右下角，保证小屏幕不会被裁掉
    self.player.view.ntesBottom = superview.ntesBottom;
    self.player.view.ntesRight  = superview.ntesWidth;
}
