...
- (void)layoutSubviews
{
    ...
    self.avatar.ntesBottom  = self.ntesHeight * .5f - 40.f;
    self.avatar.ntesCenterX = self.ntesWidth * .5f;
    self.nameLabel.ntesCenterX = self.ntesWidth * .5f;
    self.nameLabel.ntesTop  = self.avatar.ntesBottom + 7.f;
    self.statusLabel.ntesTop = self.nameLabel.ntesBottom + 18.f;
...
- (UIButton *)backButton
{
    if (!_backButton) {
        ...
        _backButton.ntesSize = CGSizeMake(215, 46);
        _backButton.ntesCenterX = self.ntesWidth * .5f;
        _backButton.ntesBottom  = self.ntesHeight - 80.f;
