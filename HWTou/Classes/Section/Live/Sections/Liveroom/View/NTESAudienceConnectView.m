...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [_nameLabel setTextColor:UIColorFromRGB(0x999999)];
        [_bar addSubview:_nameLabel];
        
        _cancelButton = [UIButton buttonWithType:UIButtonTypeCustom];
        _cancelButton.ntesHeight = 40.f;
...
- (void)layoutSubviews
{
    ...
    self.cancelButton.ntesWidth = self.ntesWidth - 2 * buttonSpacing;
    ...
    self.titleLabel.ntesTop = top;
    self.titleLabel.ntesCenterX = self.ntesWidth * .5f;
    self.avatar.ntesTop = self.titleLabel.ntesBottom + titleAndAvatarSpacing;
    self.avatar.ntesCenterX = self.ntesWidth * .5f;
    self.nameLabel.ntesTop = self.avatar.ntesBottom + avatarAndNameSpacing;
    self.nameLabel.ntesCenterX = self.ntesWidth * .5f;
    self.cancelButton.ntesTop  = self.nameLabel.ntesBottom + nameAndButtonSpacing;
    self.cancelButton.ntesCenterX = self.ntesWidth * .5f;
}
