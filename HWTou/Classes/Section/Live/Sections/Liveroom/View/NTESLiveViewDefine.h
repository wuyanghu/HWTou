...
typedef NS_ENUM(NSInteger, NTESLiveMuteType){
    NTESLiveTempMuteType,//临时禁言
    NTESLiveRelieveMuteType,//解除禁言
    NTESLiveAllMuteType,//全体禁言
    NTESLiveRelieveAllMuteType,//全体解除禁言
};
...
typedef NS_ENUM(NSInteger, NTESLiveActionType)
{
    ...
    NTESLiveActionTypeMixAudio,  //混音(背景音)
    NTESLiveActionTypeSpecalAudio,  //混音(特效音)
    ...
    NTESLiveActionTypeRed,      //红包
    NTESLiveActionTypeGift,     //礼物
    NTESLiveActionTypeNotice,//通知
    NTESLiveActionTypeAttend,//关注
    NTESLiveActionTypeGiftList,//打赏列表
    NTESNoLiveFooterViewTypePlay,//没有主播播放音乐
    NTESNoLiveFooterViewTypePause,//没有主播播放音乐
    NTESLiveFooterViewTypePlay,//有主播播放
    NTESLiveFooterViewTypePause,//有主播暂停
    NTESRefreshOnlineInfo,//刷新在线人数，打赏等
};
...
typedef NS_ENUM(NSInteger, NTESLiveCustomNotificationType)
{
    ...
    NTESLiveCustomNotificationTypeStopLive      = 6,  //停止直播
};
