...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.image = [[UIImage imageNamed:@"zb_img_bg"] resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10) resizingMode:UIImageResizingModeStretch];
...
//    CGFloat top = 162.f;
//    self.micView.ntesTop = top;
//    self.micView.ntesCenterX = self.ntesWidth * .5f;
}
