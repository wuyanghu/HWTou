...
@interface NTESGrowingTextView()<UITextViewDelegate>

@property (nonatomic,strong) NTESGrowingInternalTextView *textView;
...
@implementation NTESGrowingTextView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NTESGrowingInternalTextView *textView = [[NTESGrowingInternalTextView alloc] initWithFrame:rect];
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        NTESGrowingInternalTextView *textView = [[NTESGrowingInternalTextView alloc] initWithFrame:CGRectZero];
        self.textView = textView;
...
- (void)fitToScrollView{
    ...
    if ([self.textViewDelegate respondsToSelector:@selector(didChangeHeight:)]) {
...
@implementation NTESGrowingTextView(TextView)
