...
- (void)viewDidLoad {
    ...
    UIImageView *trafficBGImageView = [[UIImageView alloc] initWithFrame:self.view.bounds];
    trafficBGImageView.image = [UIImage imageNamed:@"home_traffic_bg"];
    [self.view addSubview:trafficBGImageView];
...
//    uLikeModel.flag = 3;
//    uLikeModel.rtcId = 20211884;
//    [Navigation showAudioPlayerViewController:self radioModel:uLikeModel];
}
