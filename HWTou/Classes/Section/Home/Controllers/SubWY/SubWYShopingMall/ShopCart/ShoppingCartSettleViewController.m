//
//  ShoppingCartSettleViewController.m
//  HWTou
//
...
@interface ShoppingCartSettleViewController ()<UITableViewDataSource,UITableViewDelegate>
@property (weak, nonatomic) IBOutlet UILabel *payPriceLabel;
@property (weak, nonatomic) IBOutlet UITableView *tableView;

@end

@implementation ShoppingCartSettleViewController
...
- (IBAction)goPayAction:(id)sender {
    ...
    [ShopMallRequest addGoodsOrder:param Success:^(AnswerLsDict *response) {
        if (response.status == 200) {
            ...
            payWayVC.type = PayWayTypeDetail;
...
- (void)dataInit{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"ShopCartSettleDetailTableViewCell" bundle:nil]
         forCellReuseIdentifier:[ShopCartSettleDetailTableViewCell cellReuseIdentifierInfo]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        ...
        ShopCartSettleDetailTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:[ShopCartSettleDetailTableViewCell cellReuseIdentifierInfo] forIndexPath:indexPath];
