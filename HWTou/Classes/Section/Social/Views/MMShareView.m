...
- (void)createUI
{
    ...
    [self mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.mas_equalTo(CGRectGetWidth([UIScreen mainScreen].bounds)).priorityHigh();
    ...
    [_btnCancel setBackgroundImage:[UIImage mm_imageWithColor:[UIColor lightGrayColor]] forState:UIControlStateHighlighted];
