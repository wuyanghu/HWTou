...
const NSTimeInterval kYLMaxTimeStep = 1; // note: To avoid spiral-o-death
...
- (void)setImage:(UIImage *)image
{
    ...
    if ([image isKindOfClass:[YLGIFImage class]] && image.images) {
        ...
        self.loopCountdown = self.animatedImage.loopCount ?: (self.animationRepeatCount ?: NSUIntegerMax);
        [self startAnimating];
    } else {
...
- (void)changeKeyframe:(CADisplayLink *)displayLink
{
    ...
    self.accumulator += fmin(displayLink.duration, kYLMaxTimeStep);
